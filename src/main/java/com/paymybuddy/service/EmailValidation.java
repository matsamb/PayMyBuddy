...
public class EmailValidation implements 
		ConstraintValidator<ValidatedEmail, String> {

	private final static String EMAIL_FORMAT="(?:[a-z0-9!#$%&'*+/=?^_`"
			+ "{|}~-]+(?:\\.[a-z0-9!#$%&'*+/=?^_`{|}~-]+)*|\"(?:[\\x01"
			+ "-\\x08\\x0b\\x0c\\x0e-\\x1f\\x21\\x23-\\x5b\\x5d-\\x7f]"
			+ "|\\\\[\\x01-\\x09\\x0b\\x0c\\x0e-\\x7f])*\")@(?:(?:[a-z"
			+ "0-9](?:[a-z0-9-]*[a-z0-9])?\\.)+[a-z0-9](?:[a-z0-9-]*[a"
